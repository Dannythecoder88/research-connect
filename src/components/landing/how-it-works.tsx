...
export function HowItWorksSection({ role, isLoggedIn }: HowItWorksSectionProps) {
  const showStudent = !isLoggedIn || role === "student";
  const showResearcher = !isLoggedIn || role === "researcher";
        ...
        <FadeIn className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            {isLoggedIn && role === "student"
              ? "Here's your roadmap to landing a research position."
              : isLoggedIn && role === "researcher"
              ? "Here's how to find and mentor talented young researchers."
              : "Whether you're a student looking for your first research experience or a lab seeking motivated young researchers, we make it simple."}
          </p>
        </FadeIn>

        <div className={`grid ${showStudent && showResearcher ? "lg:grid-cols-2 gap-16 lg:gap-20" : "max-w-xl mx-auto"}`}>
          {/* For Students */}
          {showStudent && (
            <div>
              <FadeIn>
